...
A separate, static Class 12 Mathematics learning website for **Chapter 4: Determinants**. It is part of **MathsForge** and is built as a frontend-only project, so it can be shared publicly through Netlify or GitHub Pages without paid hosting, paid APIs, databases, or subscriptions.
...
```text
https://determinants-forge.netlify.app/
```

GitHub Pages public website:

```text
https://armaankapoor-ship-it.github.io/mathsforge-chapter-4/
```

GitHub repository:

```text
https://github.com/armaankapoor-ship-it/mathsforge-chapter-4
```

## What Is Included

- Topic notes for Determinants
- Formula sheet
...
2. Create a new public repository named `mathsforge-chapter-4`.
